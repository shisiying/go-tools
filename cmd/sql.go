...
import (
	"github.com/shisiying/go-tools/internal/sql2struct"
...
func init() {
	...
	sql2structCmd.Flags().StringVarP(&charset, "charset", "", "", "请输入数据库的编码")
	sql2structCmd.Flags().StringVarP(&dbType, "dbType", "", "", "请输入数据库的类型")
	sql2structCmd.Flags().StringVarP(&dbName, "dbName", "", "", "请输入数据库名称")
	sql2structCmd.Flags().StringVarP(&tableName, "tableName", "", "", "请输入数据库表名称")
}
